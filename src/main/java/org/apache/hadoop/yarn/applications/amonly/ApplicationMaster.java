...
public class ApplicationMaster {
  ...
  private long appMasterTimeout = 600000;
  ...
  public boolean init(String[] args) throws ParseException, IOException {
    ...
    opts.addOption("timeout", true, "AppMaster timeout in milliseconds");
    ...
    */
    ...
    appMasterTimeout = Long.parseLong(cliParser.getOptionValue("timeout", "600000"));
    return true;
  }
  ...
  public void run() throws YarnException, IOException, InterruptedException {
    ...
    if (numTotalContainersToRequest <= 0) {
      Thread.sleep(appMasterTimeout);
    }
