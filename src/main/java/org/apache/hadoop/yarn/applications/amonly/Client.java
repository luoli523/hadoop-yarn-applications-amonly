...
package org.apache.hadoop.yarn.applications.amonly;
...
public class Client {
  ...
  public Client(Configuration conf) throws Exception  {
    this(
      "org.apache.hadoop.yarn.applications.amonly.ApplicationMaster",
      conf);
  }
  ...
  public boolean init(String[] args) throws ParseException {
    ...
    appName = cliParser.getOptionValue("appname", "DLMachineApply");
    ...
    numContainers = Integer.parseInt(cliParser.getOptionValue("num_containers", "0"));
  ...
  public boolean run() throws IOException, YarnException {
    ...
    vargs.add("--timeout " + String.valueOf(clientTimeout));
  ...
  private boolean monitorApplication(ApplicationId appId)
    ...
    while (true) {
      ...
      // Check app status every 1 minite.
      try {
        Thread.sleep(60000);
      ...
      if (System.currentTimeMillis() > (clientStartTime + clientTimeout + 10000)) {
